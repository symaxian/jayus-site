...
this.yPoints[i],point);this.xPoints[i]=point.x;this.yPoints[i]=point.y}this.frameDirty=true;return this},getTransformed:function Polygon_getTransformed(matrix){jayus.debug.match("Polygon.getTransformed",matrix,"matrix",10);return this.getTransformedOnto(matrix,new jayus.Polygon)},getTransformedOnto:function Polygon_getTransformedOnto(matrix,ret){jayus.debug.matchArguments("Polygon.getTransformedOnto",arguments,"matrix",10,"ret",15);var i,point=new jayus.Point;for(i=0;i<this.xPoints.length;i++){matrix.transformPointOnto(this.xPoints[i],
