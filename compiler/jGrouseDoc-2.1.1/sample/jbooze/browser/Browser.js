		...
		jbooze.define('jbooze.browser.BaseBrowser', 'jbooze.BaseObject', function(salt)
		{
			...
			return  {
				...
				*/
				...
				/**
					Get attribute of DOM entity. 
					@function {string} getAttribute
					@param {DOMElement} domEntity 
					@param {string} attrName
					@returns value of retrieved attribute
				*/
				getAttribute : function(domEntity, attrName)
				{
					return domEntity.getAttribute(attrName);
				},
				...
				*/
				clearAttributes : function(element)
				{
					...
					{
						attrNames.push(attrs.item(i).entityName);
					}
		...
		jbooze.define('jbooze.browser.Explorer', 'jbooze.browser.BaseBrowser', function(salt)
		{
			...
			return {
				...
				*/				
				getAttribute : function(domEntity, attrName)
				{
					return domEntity.getAttribute(attrName, 2); // returns value exactly as it was set in script or source doc
				},
